package mx.edu.ittepic.a331_serviciosweb_zulmacoronel;
...
public class MainActivity extends AppCompatActivity implements AsyncResponse, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void cargarAlumnos() {
        try {
            ...
            URL direccion = new URL("https://zicl.000webhostapp.com/datos/obtener_alumnos.php");
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            URL direccion = new URL("https://zicl.000webhostapp.com/datos/obtener_alumno_por_id.php" + editIDalumno.getText().toString());
                            conexionWeb.execute(direccion);
                        } catch (MalformedURLException e) {
                            Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            URL direccion = new URL("https://zicl.000webhostapp.com/datos/insertar_alumno.php");
                            conexionWeb.execute(direccion);
                        } catch (MalformedURLException e) {
        ...
        dialogo1.setPositiveButton("Eliminar", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo1, int id) {
                ...
                try {
                    ...
                    conexionWeb.agregarJSON(String.valueOf(agregar_alumno));
                    try {
                        URL direccion = new URL("https://zicl.000webhostapp.com/datos/borrar_alumno.php");
                        conexionWeb.execute(direccion);
                    } catch (MalformedURLException e) {
                        Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
    ...
    public void editarAlumno(String idalumn, String nombre, String direccion) {
        ...
        dialogBuilder = new AlertDialog.Builder(this);
        LayoutInflater inflater = this.getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.editar_alumno, null);
        dialogBuilder.setView(dialogView);
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    try {
                        btnAgregar.setEnabled(false);
                        URL direccion = new URL("https://zicl.000webhostapp.com/datos/actualizar_alumno.php");
                        conexionWeb.execute(direccion);
                    } catch (MalformedURLException e) {
                        Toast.makeText(MainActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
