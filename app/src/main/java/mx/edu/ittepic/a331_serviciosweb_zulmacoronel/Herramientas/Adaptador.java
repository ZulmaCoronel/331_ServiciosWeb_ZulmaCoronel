package mx.edu.ittepic.a331_serviciosweb_zulmacoronel.Herramientas;
...
public class Adaptador  extends RecyclerView.Adapter<AdaptadorAlumno.ViewHolderAlumnos> implements View.OnClickListener,View.OnCreateContextMenuListener,Filterable {
    ...
    public ViewHolderAlumnos onCreateViewHolder(ViewGroup parent, int viewType) {
        int layout= R.layout.vista_principal;
